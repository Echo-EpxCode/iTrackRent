        ...
        <section class="py-5 bg-light" style="padding-top: 100px;">
            <div class="container">
                <div class="row justify-content-center text-center mb-2">
                    <div class="col-lg-8">
                        <h1 class="display-5 fw-bold text-danger mb-4"> CASA DENCIA LODGE</h1>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="property-card h-100 p-4">
                            ...
                            <div class="d-flex align-items-center mb-4">
                                <h3 class="text-success mb-0 me-3">₱700<span class="fs-5">/night</span></h3>
                                <span class="badge bg-success fs-6">Available Now</span>
                            </div>

                            <p class="mt-4 lead">Welcome sa Casa Dencia Lodge, usa ka komportable ug limpyo nga kapuy-an nga perfect para sa short stay ug overnight..</p>
                            ...
                            <p class="mt-4 lead">Affordable ug swak sa budget, perfect para sa travelers ug magpahulay lang..</p>
