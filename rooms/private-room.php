        ...
        <section class="py-5 bg-light" style="padding-top: 100px;">
            <div class="container">
                <div class="row justify-content-center text-center mb-2">
                    <div class="col-lg-8">
                        <h1 class="display-5 fw-bold text-danger mb-4">DOTTIES INN BOARDING HOUSE
                        </h1>
                    </div>
                </div>
                <div class="row align-items-center">
                        ...
                        <div class="row g-2 h-100">
                            ...
                            <div class="col-6">
                                <div class="overflow-hidden rounded-4 shadow h-100" style="height: 300px;">
                                    <img src="../assets/images/dotties.jpg"
                            ...
                            <div class="col-6">
                                <div class="overflow-hidden rounded-4 shadow h-100" style="height: 300px;">
                                    <img src="../assets/images/dotties1.jpg"
                                        class="img-fluid w-100 h-100"
                                        style="object-fit: cover;"
                                        alt="">
                                </div>
                    ...
                    <div class="col-md-6">
                        <div class="property-card h-100 p-4">
                            ...
                            <p class="mt-4 lead">Welcome sa Dotties Inn Boarding House, usa ka komportable ug limpyo nga puy-anan nga angay para sa students ug workers.</p>

                            <ul class="feature-list">
                                <li>✔️ Fully furnished rooms</li>
                                <li>✔️ Naa’y aircon para presko ug hayahay ang pagpuyo</li>
                            ...
                            <p class="mt-4 lead">Affordable ug swak sa budget, perfect para sa long-term stay.</p>
