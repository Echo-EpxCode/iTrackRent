        ...
        <section class="py-5 bg-light" style="padding-top: 100px;">
            <div class="container">
                <div class="row justify-content-center text-center mb-2">
                    <div class="col-lg-8">
                        <h1 class="display-6 fw-bold text-danger mb-4">Studio-Type / Premium Boarding House</h1>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="property-card h-100 p-4">
                            ...
                            <div class="d-flex align-items-center mb-4">
                                <h3 class="text-success mb-0 me-3">₱7,000<span class="fs-5">/month</span></h3>
                            ...
                            <p class="mt-4 lead">Experience a more independent lifestyle with your own private space. Designed for comfort, convenience, and a modern living experience.</p>
