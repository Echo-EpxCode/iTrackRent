        ...
        <section class="py-5">
            <div class="container">
                <div class="row justify-content-center text-center mb-2">
                    <div class="col-lg-8">
                        <h1 class="display-5 fw-bold text-danger mb-4">DOTTIES INN BOARDING HOUSE</h1>
                    </div>
                </div>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-4">
                        <div class="h-100 p-4 border rounded-4 shadow-sm">
                            <a class="nav-link fw-bold mb-2" href="../rooms/private-room.php"><i class="fa-solid fa-angles-left"></i> Back</a>
                            ...
                            <div class="d-grid gap-2">
                                <a href="tel:+1234567890" class="btn btn-outline-primary">
                                    <i class="fas fa-phone me-2"></i> 0909 762 3269
                                </a>
                            </div>
                        </div>
                    </div>
