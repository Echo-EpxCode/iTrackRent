                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-4">
                        <div class="h-100 p-4 border rounded-4 shadow-sm">
                            <a class="nav-link fw-bold mb-2" href="../rooms/budget-lodge.php"><i class="fa-solid fa-angles-left"></i> Back</a>

                            <h3 class="text-success mb-4"><i class="fas fa-map-pin me-2"></i>Address</h3>
                            <address class="mb-4">
                                <strong>Atbang Shell, Serin Street</strong><br>
                                Poblacion <br>
