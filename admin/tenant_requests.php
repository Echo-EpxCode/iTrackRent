...
// Query for Tenants 
$sql = "SELECT `id`,`name`, `email`,`role`,`phone`, `status`, `created_at` FROM users WHERE `role` = 'tenant' AND `status` = 'pending'";
...
<body>
    ...
    <div class="main-content mt-4">
        ...
        <div class="dashboard-header">
            <h1 class="dashboard-title">Tenant Requests</h1>
            <p class="dashboard-subtitle">Review and approve tenant registration requests</p>
        </div>
        <div class="row">
            <div class="col-md-12">
                <!-- Add Form Here -->
